...
changes to Peercoin libraries, dependencies, algorithms or the RFC process itself.
...
parallelism, trap more errors…etc…)
   - Additions only likely to be _noticed by_ other developers-of-peercoin,
invisible to app-developers-of-peercoin (i.e. API users)
...
into Peercoin, at which point it becomes "active".

* Fork the RFC repo https://github.com/peercoin/rfcs
